...
import { DijkstraAlgorithm } from "../algorithms/DjikstraAlgorithm";
import { Mediator } from "../mediator/Mediator";
import { GridStore } from "../stores/GridStore";

export class DjikstraCommandHandler implements CommandHandler<DjikstraCommand> {
  constructor(
  ...
  execute(): void {
    ...
    const algorithm = DijkstraAlgorithm.create(grid, startNode, endNode);
